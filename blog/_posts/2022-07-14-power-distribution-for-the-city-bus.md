...
{% include figure src="/blog/circuit-sketch.jpg" caption="Sketch of the circuit - colour coded" align="centre" %}
...
{% include figure src="/blog/circuit-top.jpg" caption="Close up of the top of the circuit board" align="centre" %}
...
{% include figure src="/blog/circuit-bottom.jpg" caption="Close up of the bottom of the circuit board" align="centre" %}
