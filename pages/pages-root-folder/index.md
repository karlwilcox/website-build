...
All text content on this site is written by a human (me!) Some of it is
written long-hand using my collection of fine fountain pens and converted
to electronic text by ChatGPT, however this is a faithful transcript with
no rewriting or embellishment.

### Images

All photographs are mine unless otherwise stated. Review images are mostly
from bookstores or the originating TV network. Images are used for criticism
only and no copyright violation is intended. Some artwork is generated by
AI but this is clearly stated and where possible I have included the prompt
used to generate it.
